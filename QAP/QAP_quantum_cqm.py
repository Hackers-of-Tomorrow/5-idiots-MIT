...
def quantum_solution(N_rooms, N_supply, flow, room_supply_distance, room_room_distance, supply_supply_distance, time_steps):
    ...
    total_cost = 0
    # Generate the constrained quadratic model
    cqm = ConstrainedQuadraticModel()

    # Add variables for each room and supply as a binary variable

    for i in N_rooms:
        cqm.add_variable(vartype='BINARY', v='room' + i)

    for i in N_supply:
        cqm.add_variable(vartype='BINARY', v='supply' + i)
